    ...
    <style>
        * {
        ...
        .intro-bg {
            position: absolute;
            inset: 0;
            background: radial-gradient(ellipse at center, #0d1929 0%, #050a12 100%);
            z-index: 0;
        }
        ...
        .intro-tech-character {
            position: absolute;
            bottom: -340px;              /* starts hidden below screen */
            left: 50%;
            transform: translateX(-50%);
            z-index: 3;
            width: 320px;
            animation: techWalkIn 1.2s cubic-bezier(0.34, 1.56, 0.64, 1) 1.4s forwards;
        }

        @keyframes techWalkIn {
        ...
        .wave-arm {
            ...
            animation: waveArm 1s ease-in-out 2.8s 3;
        }
        ...
        .intro-speech-bubble {
            ...
            border-radius: 20px;
            white-space: nowrap;
            box-shadow: 0 8px 30px rgba(0,0,0,0.4), 0 0 20px rgba(56,189,248,0.4);
            opacity: 0;
            animation: bubbleAppear 0.5s ease-out 2.7s forwards;
        }
        ...
        .intro-center-panel {
            ...
            gap: 10px;
            opacity: 0;
            animation: introFadeUp 0.6s ease-out 0.5s both;
        }
        ...
        /* Laser Scan Line Beam across Intro Screen */
        .intro-laser-scan {
            position: absolute;
            top: 0;
            left: 0;
            ...
            opacity: 0.8;
            animation: introLaserSweep 4s ease-in-out infinite alternate;
            pointer-events: none;
        }

        @keyframes introLaserSweep {
            0% { top: 0%; }
            100% { top: 100%; }
        }
        ...
        .skip-intro-btn {
            ...
            cursor: pointer;
            backdrop-filter: blur(14px);
            box-shadow: 0 6px 20px rgba(0, 0, 0, 0.3), 0 0 15px rgba(56, 189, 248, 0.4);
            transition: all 0.25s ease;
            display: flex;
            align-items: center;
            gap: 8px;
        ...
        /* Floating Badges Row on Intro Screen */
        .intro-badges-row {
            display: flex;
            align-items: center;
            justify-content: center;
            ...
            flex-wrap: wrap;
            margin-bottom: 20px;
            animation: introFadeUp 0.6s ease-out 0.2s both;
        }

        .intro-badges-row .tech-badge {
            position: relative;
            top: auto;
            left: auto;
            right: auto;
        ...
        .intro-logo-wrapper {
            ...
            justify-content: center;
            margin-bottom: 24px;
            animation: introLogoZoom 1s cubic-bezier(0.16, 1, 0.3, 1) both;
        }
        ...
        .intro-title {
            ...
            text-shadow: 0 0 20px rgba(56, 189, 248, 0.7), 0 0 40px rgba(129, 140, 248, 0.5);
            animation: introFadeUp 0.6s ease-out 0.3s both;
        }
        ...
        .intro-subtitle {
            ...
            margin: 0 0 20px 0;
            font-weight: 500;
            animation: introFadeUp 0.6s ease-out 0.4s both;
        }
        ...
        .intro-boot-status {
            ...
            width: 100%;
            margin-bottom: 16px;
            box-shadow: inset 0 0 15px rgba(0,0,0,0.5), 0 0 20px rgba(56, 189, 248, 0.2);
            animation: introFadeUp 0.6s ease-out 0.5s both;
        }
        ...
        .status-line.line-1 { animation-delay: 0.7s; }
        .status-line.line-2 { animation-delay: 1.4s; }
        .status-line.line-3 { animation-delay: 2.1s; }
        ...
        /* Mini Animated Computer Service Graphic in Intro */
        .intro-mini-service {
            width: 100%;
            margin-bottom: 20px;
            display: flex;
            justify-content: center;
            animation: introFadeUp 0.6s ease-out 0.6s both;
        }
        ...
        .logo-glow-wrapper:hover .logo-box {
            ...
            box-shadow: 
                ...
                0 0 120px rgba(244, 114, 182, 0.85);
        }
        ...
        .login__input:focus {
            ...
            border-color: #6366f1;
            outline: none;
            box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.18), 0 10px 20px -5px rgba(99, 102, 241, 0.15);
            transform: translateY(-2px);
        }
        ...
        .login-btn {
            ...
            box-shadow: 0 10px 25px -5px rgba(37, 99, 235, 0.5), 0 0 15px rgba(79, 70, 229, 0.3);
            position: relative;
            overflow: hidden;
        ...
        .login-btn:hover {
            ...
            box-shadow: 0 16px 32px -5px rgba(37, 99, 235, 0.65), 0 0 25px rgba(99, 102, 241, 0.5);
        }
...
<body class="login">
    ...
    <div id="introOverlay" class="intro-overlay">
        ...
        <!-- ANIMATED TECHNICIAN CHARACTER (Orang Servis, muncul dari bawah, melambai) -->
        ...
        <div class="login-right">
            ...
            <div class="footer-card">
                ...
                <div class="live-widget">
                    <div id="greetingText">Selamat Datang</div>
