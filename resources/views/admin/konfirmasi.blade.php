...
<div class="content">
    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        ...
        <div class="nav-tabs flex flex-row overflow-x-auto gap-2 pb-1 sm:pb-0 mobile-tab-scroll justify-start"> 
            <a data-toggle="tab" data-target="#konfirmasi" role="button" class="py-3 px-4 sm:mr-4 active whitespace-nowrap">Konfirmasi Harga</a> 
            <a data-toggle="tab" data-target="#unit" role="button" class="py-3 px-4 sm:mr-4 whitespace-nowrap">Detail Unit</a>
            ...
            <div class="intro-y box col-span-12">
                ...
                <div class="p-5">
                    <form method="post" action="{{ route('admin.update_konf') }}">
                        ...
                        <input type="hidden" name="tras_kode" value="{{ $proses['trans_kode'] ?? ($trans->trans_kode ?? '') }}">
