                                ...
                                foreach ($karyawan_list as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge" style="background-color: <?= $bg_color ?>; color: white; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-size: 0.75rem;">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-sm btn-outline-primary edit-btn"
                                                        ...
                                                        data-status="<?= htmlspecialchars(isset($row->kry_status) ? $row->kry_status : 1); ?>"                                                        data-tgl-masuk="<?= $row->kry_join_date; ?>">
...
<script>
    ...
    document.addEventListener('click', function(e) {
        ...
        if (addBtn) {
            ...
            if (document.getElementById('kry_status')) document.getElementById('kry_status').value = '1';
        ...
        if (editBtn) {
            ...
            if (document.getElementById('kry_status')) document.getElementById('kry_status').value = ds.status || '1';
